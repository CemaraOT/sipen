		<div class="container">
			<div class="row">
				...
				<div class="col-md-9" style="border-left:1px solid #f3f3f3;">
					...
					<div class="row-fluid">
						<?php
							$this->m_peta->set_id_kategori($this->uri->segment(2));
							$query = $this->m_peta->tampil_peta_by_id_kategori();
							foreach($query->result() as $row){
						?>
						<div class="col-md-6">
							<div class="thumbnail">
								...
								<img width="100%"src="<?php echo base_url(); ?>assets/img/peta/<?php echo $row->gambar; ?>" alt="">		
								...
								<hr />
								<div class="ratings">
									<p class="pull-right"><i>Sumber : <?php echo $row->sumber; ?></i></p>
								</div>
