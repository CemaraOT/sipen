					...
					<div class="col-md-12">
						<div class="row-fluid" style="padding-top:20px;">
							...
							<div class="pull-right" style="padding-top:20px;">
								<a href="<?php echo site_url(); ?>admin_peta/tambah"><i class="fa fa-plus"></i> Tambah</a>
							</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Apakah anda yakin ingin menghapus peta ?</p>
				<input type="hidden" name="id_peta" id="id_peta">
			</div>
