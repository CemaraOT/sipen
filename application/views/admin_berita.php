					...
					<div class="col-md-12">
						<div class="row-fluid" style="padding-top:20px;">
							...
							<div class="pull-right" style="padding-top:20px;">
								<a href="<?php echo site_url(); ?>admin_berita/tambah"><i class="fa fa-plus"></i> Tambah</a>
							</div>
						...
						<div class="row-fluid">
							<div class="table-responsive">
								<table class="table table-bordered table-condensed display" id="table">
									...
									<tbody>
										<?php
											$query = $this->m_berita->tampil_berita();
											...
											<td>
												<div class="text-center">
													<button type="button" class="btn btn-info btn-rounded" style="width:40px; height:40px;"
														onclick="window.location.href='<?php echo site_url(); ?>admin_berita/ubah/<?php echo $row->id_berita; ?>'">
													...
													<button type="button" class="btn btn-danger btn-rounded hapus" style="width:40px; height:40px;"
														title="Hapus" data-toggle="modal" data-target="#modal_konfirmasi" id="hapus_<?php echo $row->id_berita; ?>">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#hapus').click(function() {
			window.location = '<?php echo site_url();?>admin_berita/hapus_berita/' + $('#id_berita').val();
		});
