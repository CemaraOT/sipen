								...
								<table class="table table-bordered table-condensed display" id="table">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td>Banjir</td>
											<td>Banjir Bandang Menlanda Kota</td>
											<td>
												<div class="text-center">
													<button type="button" class="btn btn-info btn-rounded" style="width:40px; height:40px;"
														onclick="window.location.href='<?php echo site_url(); ?>admin_berita/ubah/'">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#hapus').click(function() {
			window.location = '<?php echo site_url();?>admin_berita/hapus/' + $('#id_berita').val();
		});
