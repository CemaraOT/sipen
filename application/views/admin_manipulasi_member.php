			<div id="page-wrapper">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row-fluid">
							<form method="post" action="<?php echo site_url(); ?>admin_manajemen/ubah_member/<?php echo $id_member; ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="password" placeholder="Password" value="<?php echo $password; ?>" readonly />
								</div>
